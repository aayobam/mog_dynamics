...
class AdminSalary3month(admin.ModelAdmin):
    ...
    readonly_fields = ("percentage", "monthly_payment", "first_payment", "payment_date_1", "second_payment", "payment_date_2", "third_payment", "payment_date_3", "reference_no", "duration")
    list_filter = ("reference_no", "investment_date", "investor_name")
    search_fields = ("reference_no", "phone_no")
    actions = ["first_payment", "payment_date_1", "second_payment", "payment_date_2", "third_payment", "payment_date_3"]
    list_per_page = 10
...
class AdminFixedPackage3Month(admin.ModelAdmin):
    list_display = ("investor_name", "phone_no", "capital", "percentage", "duration", "returns", "returns_payout_date", "payout_status", "reference_no", investment_pdf_3months)
    list_filter = ("reference_no", "investor_name")
    readonly_fields = ("percentage", "payout_status", "returns", "duration", "reference_no",)
    search_fields = ("reference_no", "phone_no")
...
class AdminFixedPackage6Month(admin.ModelAdmin):
    list_display = ("investor_name", "phone_no", "capital", "percentage", "duration", "returns", "returns_payout_date", "payout_status", "reference_no", investment_pdf_6months)
    list_filter = ("reference_no", "investor_name")
    readonly_fields = ("percentage", "payout_status", "returns", "duration", "reference_no",)
    search_fields = ("reference_no", "phone_no")
    actions = ["update_payout_status"]
...
class AdminFixedPackage9Month(admin.ModelAdmin):
    list_display = ("investor_name", "phone_no", "capital", "percentage", "duration", "returns", "returns_payout_date", "payout_status", "reference_no", investment_pdf_9months)
    list_filter = ("reference_no", "investor_name")
    readonly_fields = ("percentage", "payout_status", "returns", "duration", "reference_no",)
    search_fields = ("reference_no", "phone_no")
    actions = ["update_payout_status"]
...
class AdminFixedPackage12Month(admin.ModelAdmin):
    list_display = ("investor_name", "phone_no", "capital", "percentage", "duration",
                    "returns", "returns_payout_date", "payout_status", "reference_no", investment_pdf_12months)
